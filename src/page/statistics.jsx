  ...
  return (
    <div className="relative h-100">
      <div className="mb-3">
        ...
        <button
          className="absolute top-[50%] left-3 z-10 bg-[transparent] text-[25px] w-[50px] h-[50px] rounded-full shadow-lg"
          onClick={() => swiperRef.current?.slidePrev()}
        >
          <i className="bi bi-arrow-left"></i>
        </button>
        <button
          className="absolute top-[50%] right-3 z-10 bg-[transparent] text-[25px] w-[50px] h-[50px] rounded-full shadow-lg"
